...
void _before_run_synapses_post_push_spikes()
{
    using namespace brian;
    ///// CONSTANTS ///////////
    const int64_t _n_sources = 3;
const int64_t _n_targets = 5;
const size_t _num_source_dt = 1;
const size_t _num_spikespace = 4;
double* const _array_synapses_delay_1 = _dynamic_array_synapses_delay_1.empty()? 0 : &_dynamic_array_synapses_delay_1[0];
const size_t _numdelay = _dynamic_array_synapses_delay_1.size();
    ///// POINTERS ////////////
        
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    int32_t* __restrict  _ptr_array_neurongroup__spikespace = _array_neurongroup__spikespace;
    double* __restrict  _ptr_array_synapses_delay_1 = _array_synapses_delay_1;
    ...
    const size_t n_synapses = synapses_post.sources.size();
    synapses_post.prepare(_n_sources,
                           _n_targets,
